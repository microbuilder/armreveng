...
> For Cortex-M devices, you will usually need to look at the 16-bit Thumb
  ...
  v7,8. For example, on Armv6-M Thumb (Cortex M0), you can typically only
  operate on the `lo` (`{r0-r7}`) registers, compared to Thumb-2 Armv7-M
  and higher (Cortex M3/M4/M7) where you can use the full range of `{r0-r11}`,
